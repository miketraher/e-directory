...
AS
SELECT     e.emp_id, e.last_name, e.first_name, e.job_title, e.job_role, e.extension_number, e.phone_number, e.mobile_number, e.email_address, e.skype_id, 
                      c.ctry_name, e.ctry_id, d.division_name, e.division_id, comp.company_name, e.company_id, dept.dept_name, e.dept_id, s.site_name, e.site_id, 
...
FROM         dbo.employee AS e LEFT OUTER JOIN
                      ...
                      dbo.company_lookup AS comp ON e.company_id = comp.company_id LEFT OUTER JOIN
