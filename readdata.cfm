...
<cfloop query="qdata">
   <cfquery datasource="dir_sqlserver" result="qresult">
              ...
              VALUES
                    ...
                    ,<cfif (len(qdata.email_address))><cfqueryparam cfsqltype="cf_sql_varchar" value="#qdata.email_address#"><cfelse><cfqueryparam cfsqltype="cf_sql_varchar" value="#qdata.calc_email#"></cfif>
